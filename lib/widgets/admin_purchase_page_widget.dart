...
import '../services/admin_purchase_data_service.dart';
...
class _AdminPurchasePageWidgetState extends State<AdminPurchasePageWidget> {
  ...
  Future<void> _loadPurchaseData() async {
    ...
    try {
      final data = await AdminPurchaseDataService.getWeeklyPurchaseData();
      final chart = await AdminPurchaseDataService.getWeeklyPurchaseChart();
      final cats = await AdminPurchaseDataService.getCategories();
  ...
  Future<void> _handleSearch(String query, String category) async {
    try {
      final filtered = await AdminPurchaseDataService.searchPurchaseData(
        query: query,
        category: category,
      );
  ...
  Future<void> _handleDelete(int id) async {
    ...
    try {
      final success = await AdminPurchaseDataService.deletePurchaseItem(id);
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Purchase Chart
            AdminPurchaseChartWidget(chartData: chartData),
